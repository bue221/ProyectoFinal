...
public class VSede extends javax.swing.JPanel {
    ...
    private void listar(){
       String sql= "select * from vista_sede" ;
       try{
           cn=con.getConnection();
           st=cn.createStatement();
           rs=st.executeQuery(sql);
           
           Object[]Sedes = new Object[7];
           modelo=(DefaultTableModel)TablaDatos.getModel();
           System.out.print("NSede"+rs);
           while (rs.next()){
               Sedes[0]= rs.getInt("Id");
               Sedes[1]= rs.getString("NombreSede");
               Sedes[2]= rs.getString("Ubicacion");
               Sedes[3] = rs.getDouble("TarifaC");
               Sedes[4] = rs.getDouble("TarifaM");
               Sedes[5]= rs.getInt("DisponibilidadMoto");
               Sedes[6]= rs.getInt("DisponibilidadCarro");
               modelo.addRow(Sedes);
           }
    ...
    private void initComponents() {
        ...
        TablaDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Ubicación", "Tarifa Carro", "Tarifa Moto", "Espacios Moto", "Espacios Carro"
            }
        ) {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(19, 19, 19)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtEspacio, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void TablaDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDatosMouseClicked
        ...
        if(fila==-1){
            ...
            espacios =  Integer.parseInt((String) TablaDatos.getValueAt(fila, 6).toString());
            ...
            this.comboUbi.setSelectedItem(ubicacion);
